...
#include "GKUIFrontendStateComponent.generated.h"
...
class UGKUIExperienceDefinition;

UCLASS(Abstract)
class UGKUIFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	UGKUIFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	void OnExperienceLoaded(const UGKUIExperienceDefinition* Experience);
