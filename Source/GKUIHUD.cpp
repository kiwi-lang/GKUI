...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKUIHUD)
...
AGKUIHUD::AGKUIHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AGKUIHUD::PreInitializeComponents()
{
...
void AGKUIHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AGKUIHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
