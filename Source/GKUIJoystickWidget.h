...
#include "GKUIJoystickWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="GKUI Joystick" ))
class GKUI_API UGKUIJoystickWidget : public UGKUISimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UGKUIJoystickWidget(const FObjectInitializer& ObjectInitializer);
