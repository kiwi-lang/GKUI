...
#include "GKUISimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="GKUI Simulated Input Widget" ))
class GKUI_API UGKUISimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UGKUISimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
