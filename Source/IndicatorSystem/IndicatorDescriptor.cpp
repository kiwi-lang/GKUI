...
#include "SceneView.h"
#include "IndicatorSystem/GKUIIndicatorManagerComponent.h"
...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UGKUIIndicatorManagerComponent* InManager)
{
...
{
	if (UGKUIIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
