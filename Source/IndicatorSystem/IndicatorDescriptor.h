...
class GKUI_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UGKUIIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UGKUIIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UGKUIIndicatorManagerComponent> ManagerPtr;
