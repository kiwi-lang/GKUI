...
#include "GKUIReticleWidgetBase.h"

#include "Inventory/GKUIInventoryItemInstance.h"
#include "Weapons/GKUIRangedWeaponInstance.h"
#include "Weapons/GKUIWeaponInstance.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GKUIReticleWidgetBase)

UGKUIReticleWidgetBase::UGKUIReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UGKUIReticleWidgetBase::InitializeFromWeapon(UGKUIWeaponInstance* InWeapon)
{
	WeaponInstance = InWeapon;
	InventoryInstance = nullptr;
	if (WeaponInstance)
	{
		InventoryInstance = Cast<UGKUIInventoryItemInstance>(WeaponInstance->GetInstigator());
	}
	OnWeaponInitialized();
}


float UGKUIReticleWidgetBase::ComputeSpreadAngle() const
{
	if (const UGKUIRangedWeaponInstance* RangedWeapon = Cast<const UGKUIRangedWeaponInstance>(WeaponInstance))
	{
...
bool UGKUIReticleWidgetBase::HasFirstShotAccuracy() const
{
	if (const UGKUIRangedWeaponInstance* RangedWeapon = Cast<const UGKUIRangedWeaponInstance>(WeaponInstance))
	{
...
float UGKUIReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
{
